        ...
        if(filter_var($email, FILTER_VALIDATE_EMAIL)){//if email is valid
            ...
            if(mysqli_num_rows($sql) > 0 ){//if email already exist
                ...
                if(isset($_FILES['image'])){//if file is uploaded
                    ...
                    $tm_name =  $_FILES['image'] ['tmp_name']; //this temporary name is used to save/move files in our folder
                    ...
                    if(in_array($img_ext, $extensions)== true){//if user upload img ext is matched with any array extension
                       ...
                       if( move_uploaded_file($tm_name, "images/".$new_img_name)){//if user upload img move to our folder successful
